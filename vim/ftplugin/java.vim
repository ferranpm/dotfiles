...
command! -buffer -nargs=0 AndroidInstall call system('ant installd && '.g:android_sdk_path.'/platform-tools/adb shell am start -a android.intent.action.MAIN -n '.g:android_package_name.'/'.g:android_project_name)
